...
namespace Chapter_8_Application_8
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            foreach(int keys in retiredNumbers.Keys)
            {
                comboBox1.Items.Add(keys);
            }
        ...
        {
            NameLabel.Text = retiredNumbers[(int)comboBox1.SelectedItem].Player;
            Year.Text = retiredNumbers[(int)comboBox1.SelectedItem].YearRetired.ToString();
        }
